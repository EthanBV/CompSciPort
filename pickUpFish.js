...
var areas = {
    ...
    theFishverse: {
        wayPoint: {
            loadText: function () {
                log("You are in a room, the floor is green, the roof is green, there is a lot of green. There are " + areas.theFishverse.wayPoint.items.fish + " on the ground");
            },
            items: {
                fish: 0,
                swordFish: 0,
                ...
                [
                    ...
                    [
                        ...
                        [
                            ...
                            function () {
                                if (area.theBox.inBox.status.wall) {
